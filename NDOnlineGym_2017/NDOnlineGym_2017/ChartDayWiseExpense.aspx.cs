...
{
    public partial class ChartDayWiseExpense : System.Web.UI.Page
    {
        public double jan = 0;
        ...
        //{
        //    Label16.Text = "Expense Report  In " + ddlMonth.SelectedItem.Text + " " + ddlYear.SelectedItem.Text;
        ...
        //                }
        //            }
        //            ds.Tables["ExpenseDayWise"].Rows.Add(jan);
        //            exp += jan;
        //        }
        //        ds.AcceptChanges();
        ...
        //        for (int j = 0; j <= 30; j++)
        //        {
        //            this.Chart1.Series["Expense"].Points.AddXY(j + 1, SeviceRow[j][0]);
        //            // this.chart1.Series["Expense"]["PixelPointWidth"] = "15";
        //            Chart1.ChartAreas[0].AxisX.IsMarginVisible = false;

        //        }
        //        lblTotalExpense.Text = exp.ToString();
        //    }
