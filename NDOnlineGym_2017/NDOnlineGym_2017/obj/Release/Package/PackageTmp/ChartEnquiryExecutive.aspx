<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="ChartEnquiryExecutive.aspx.cs" Inherits="NDOnlineGym_2017.ChartEnquiryExecutive" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="sc">
     <div class="form-name-header">
       <h3>Enquiry Executive Chart
           <div class="navigation">
              <ul>
                  <li>Chart &nbsp; > &nbsp;</li>
                  <li>Enquiry Executive</li>
              </ul>
           </div>
      </h3>
    </div>
    <div class="divForm">
        <div class="form-panel">
            ...
            <div id="divChart" style="width:100%;height:400px;border:1px solid silver;padding:10px" >
                <table style="width:100%;">
                    <tr>
                         <td style="width:35%"><strong>Total Enquiry : </strong><asp:Label ID="lblTotalExpense" runat="server" ></asp:Label></td>
                    </tr>
                </table>
