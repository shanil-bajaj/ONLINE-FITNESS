<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="ThumbAddMemberBlock.aspx.cs" Inherits="NDOnlineGym_2017.ThumbAddMemberBlock" ValidateRequest="false" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="width: 1000px; height: auto; overflow-x: scroll; margin-top: 20px;">
        ...
        <div style="margin: 10px 0px 10px 10px">
            <asp:Button ID="BtnAdd" runat="server" Text="Member Block" Font-Bold="true" ForeColor="Black" OnClick="BtnAdd_Click" />
