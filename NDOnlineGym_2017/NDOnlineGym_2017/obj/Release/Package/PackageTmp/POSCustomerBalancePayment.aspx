<%@ Page Title="" Language="C#" MasterPageFile="~/POSMaster.Master" AutoEventWireup="true" CodeBehind="POSCustomerBalancePayment.aspx.cs" Inherits="NDOnlineGym_2017.POSCustomerBalancePayment" %>
            ...
            <ContentTemplate>
                ...
                <div style="width: 1000px; height: auto; margin-top: 20px; overflow-x: auto">
                    ...
                    <asp:GridView ID="gvBalanceDetails" runat="server" AutoGenerateColumns="false"
                        EmptyDataText="No record found." Width="1500px" GridLines="None" CellPadding="3" Font-Size="11px" PagerStyle-CssClass="pager"
