<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="ChartMonthWiseExpense.aspx.cs" Inherits="NDOnlineGym_2017.ChartMonthWiseExpense" %>
                            ...
                            <td class="cols">
                                <table>
                                    <tr>
                                        ...
                                        <td style="width: 55%; text-align: left;">
                                             <asp:DropDownList ID="ddlChart" runat="server" CssClass="ddl" OnSelectedIndexChanged="ddlChart_SelectedIndexChanged" AutoPostBack="true" TabIndex="2">
                                                <asp:ListItem Value="--Select--">--Select--</asp:ListItem>
