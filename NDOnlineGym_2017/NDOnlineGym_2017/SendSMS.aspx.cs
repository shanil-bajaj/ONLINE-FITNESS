...
namespace NDOnlineGym_2017
{
    public partial class SendSMS : System.Web.UI.Page
    {
        ...
        {
            objSendSMS.Branch_AutoID = Convert.ToInt32(Session["Branch_ID"]);
            ...
            if (txtContactnum.Text.Length != 0 && txtIndividual.Text.Length != 0)
            {
                ...
                if (dataTable.Rows.Count > 0)
                {
                    if (dataTable.Rows[0]["SMSStatus"].ToString() == "Yes")
                    {
                        ...
                        string Message = "Dear " + MemName + " " + St + "," + txtIndividual.Text;
                ...
                {                                       
                    ...
                    for (int i = 0; i < dataTable.Rows.Count; i++)
                    {
                        ...
                        if (dataTable.Rows[i]["SMSStatus"].ToString() == "Yes")
                        {
                            ...
                            string Message = "Dear " + MemName + " " + St + "," + txtGroupSMS.Text;
                ...
                if (dataTable.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < dataTable.Rows.Count; i++)
                    {
                        ...
                        if (dataTable.Rows[i]["SMSStatus"].ToString() == "Yes")
                        {
                            ...
                            MNumber = dataTable.Rows[i]["Contact1"].ToString();
                            string Message = "Dear " + MemName + " " + St + "," + txtEnquiry.Text;
                            res1 = SendSMSFun(MNumber, Message);
                        }
                    ...
                    for (int i = 0; i < dataTable.Rows.Count; i++)
                    {
                        ...
                        if (dataTable.Rows.Count > 0)
                        {
                            if (dataTable.Rows[i]["SMSStatus"].ToString() == "Yes")
                            {
                                ...
                                MNumber = dataTable.Rows[i]["Contact1"].ToString();
                                string Message = "Dear " + MemName + " " + St + "," + txtGender.Text;
                                res1 = SendSMSFun(MNumber, Message);
