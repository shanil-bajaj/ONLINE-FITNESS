...
{
    public partial class ThumbAddMember : System.Web.UI.Page
    {
       ...
       // public int k = 0;
        ...
        protected void btnAddMember_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtMemberID_AddMember.Text != "" && txtMemberName_AddMember.Text != "" && txtSerialno_AddMember.Text != "")
                {
                    string str = k.AddEmployee(ViewState["Apikey"].ToString(),
                        txtMemberID_AddMember.Text,
                        txtMemberName_AddMember.Text,
                        txtCardNumber_AddMember.Text,
                        txtSerialno_AddMember.Text);
                    if (str == "Success")
                    {
        ...
        //    try
        //    {
        //        if (txtMemberID_DeleteMember.Text != "" && txtSerialNu_DeleteMember.Text != "")
        //        {
        //            string str = k.DeleteUser(ViewState["Apikey"].ToString(), txtMemberID_DeleteMember.Text, txtSerialNu_DeleteMember.Text);
        //            if (str == "Success")
        //            {
        //                ScriptManager.RegisterClientScriptBlock(this.Page, this.Page.GetType(), "Msg", "toastr.success('Member Delete  Successfully !!!','Success');", true);
        //            }
        //            else
        //            {
        //                ScriptManager.RegisterClientScriptBlock(this.Page, this.Page.GetType(), "Msg", "toastr.error('Error !!!','Error');", true);
