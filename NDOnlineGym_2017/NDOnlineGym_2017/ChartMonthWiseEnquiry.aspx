<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="ChartMonthWiseEnquiry.aspx.cs" Inherits="NDOnlineGym_2017.ChartMonthWiseEnquiry" %>
    ...
    <div class="divForm">
        <div class="form-panel">
                            ...
                            <td class="cols">
                                <table>
                                    <tr>
                                        ...
                                        <td style="width: 55%; text-align: left;">
                                             <asp:DropDownList ID="ddlChart" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlChart_SelectedIndexChanged" CssClass="ddl" TabIndex="2">
                                                <asp:ListItem Value="--Select--">--Select--</asp:ListItem>
                                ...
                                <table>
                                    <tr>
                                       <%-- <td style="width: 45%;"><span class="lbl">Select Chart</span></td>--%>
                                        <td>  <asp:Button ID="btnSave" runat="server" Text="Show" CssClass="form-btn" TabIndex="3" /></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
            ...
            <div id="divChart" style="width:100%;height:400px;border:1px solid silver;padding:10px" >
                <table style="width:100%;">
                    <tr>
                        <td style="width:35%"><strong>Total Enquiry : </strong><asp:Label ID="Label2" runat="server"></asp:Label></td>
                    </tr>
                </table>
