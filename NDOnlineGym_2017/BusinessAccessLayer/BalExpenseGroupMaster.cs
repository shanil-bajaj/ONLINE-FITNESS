...
{
    public class BalExpenseGroupMaster
    {
        #region ------------Public Properties -----------

        public int Expgrp_AutoID { get; set; }
        ...
        public bool Check_ExistingNameExpenseGroupMaster()
        {
            ...
            int i = obDataCon.Int_StoredProcedure_Parameter("SP_ExpenseMaster", param);
            if (i > 0)
                return true;
            else
                return false;
        ...
        public DataTable Select_ExpenseGroupMaster()
        {
            ...
            return obDataCon.DataTable_StoredProcedure_Parameter("SP_ExpenseMaster", param);
        }
        #endregion

        #region Insert record in Designation Master Table
        public int Insert_ExpenseGroupMaster()
        {
            SqlParameter[] param = new SqlParameter[5];
            param[0] = new SqlParameter("@Expgrp_AutoID", Expgrp_AutoID);
            ...
            return obDataCon.Insert_Update_Delete_StoredProcedure_Parameter("SP_ExpenseMaster", param);
        }
        #endregion

        #region Select record from Designation Master by ID
        public DataTable SelectByID_ExpenseGroupMaster()
        {
            SqlParameter[] param = new SqlParameter[4];
            param[0] = new SqlParameter("@Expgrp_AutoID", Expgrp_AutoID);
