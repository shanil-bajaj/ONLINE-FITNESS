...
{
    public class BalWorkoutNameMaster
    {
        ...
        public int MuscularGroup_AutoID { get; set; }
        ...
        public bool Check_ExistingNameWorkoutNameMaster()
        {
            ...
            int i = obDataCon.Int_StoredProcedure_Parameter("SP_WorkoutNameMaster", param);
            if (i > 0)
                return true;
            else
                return false;
        ...
        public DataTable Select_WorkoutNameMaster()
        {
            ...
            return obDataCon.DataTable_StoredProcedure_Parameter("SP_WorkoutNameMaster", param);
        }
        #endregion

        #region Insert record in Department Master Table
        public int Insert_WorkoutNameMaster()
        {
            SqlParameter[] param = new SqlParameter[6];
            param[0] = new SqlParameter("@WorkoutName_AutoID", WorkoutName_AutoID);
            param[1] = new SqlParameter("@Name", Name);
            param[2] = new SqlParameter("@Company_AutoID", Company_AutoID);
            param[3] = new SqlParameter("@Branch_AutoID", Branch_AutoID);
            param[4] = new SqlParameter("@MuscularGroup_AutoID", MuscularGroup_AutoID);
            param[5] = new SqlParameter("@Action", Action);
            return obDataCon.Insert_Update_Delete_StoredProcedure_Parameter("SP_WorkoutNameMaster", param);
        }
        #endregion

        #region Select record from Department Master by ID
        public DataTable SelectByID_WorkoutNameMaster()
        {
            SqlParameter[] param = new SqlParameter[4];
            param[0] = new SqlParameter("@WorkoutName_AutoID", WorkoutName_AutoID);
            param[1] = new SqlParameter("@Company_AutoID", Company_AutoID);
