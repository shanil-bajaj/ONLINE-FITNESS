...
{
    public class BalDepartmentMaster
    {
        #region ------------Public Properties -----------

        public int Dept_AutoID { get; set; }
        ...
        public bool Check_ExistingNameDepartmentMaster()
        {
            ...
            int i = obDataCon.Int_StoredProcedure_Parameter("SP_DepartmentMaster", param);
            if (i > 0)
                return true;
            else
                return false;
        ...
        public DataTable Select_DepartmentMaster()
        {
            ...
            return obDataCon.DataTable_StoredProcedure_Parameter("SP_DepartmentMaster", param);
        }
        #endregion

        #region Insert record in Department Master Table
        public int Insert_DepartmentMaster()
        {
            SqlParameter[] param = new SqlParameter[5];
            param[0] = new SqlParameter("@Dept_AutoID", Dept_AutoID);
            ...
            return obDataCon.Insert_Update_Delete_StoredProcedure_Parameter("SP_DepartmentMaster", param);
        }
        #endregion

        #region Select record from Department Master by ID
        public DataTable SelectByID_DepartmentMaster()
        {
            SqlParameter[] param = new SqlParameter[4];
            param[0] = new SqlParameter("@Dept_AutoID", Dept_AutoID);
            param[1] = new SqlParameter("@Company_AutoID", Company_AutoID);
