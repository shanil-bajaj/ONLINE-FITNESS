...
namespace BusinessAccessLayer
{
    public class BalTaxMaster
    {
        ...
        public DataTable Select_TaxMaster()
        {
            ...
            return obDataCon.DataTable_StoredProcedure_Parameter("SP_TaxMaster", param);
        }
        #endregion

        #region Insert record in Department Master Table
        public int Insert_TaxMaster()
        {
            SqlParameter[] param = new SqlParameter[5];
            param[0] = new SqlParameter("@Tax_AutoID", Tax_AutoID);
            ...
            return obDataCon.Insert_Update_Delete_StoredProcedure_Parameter("SP_TaxMaster", param);
        }
        #endregion
    }
}
