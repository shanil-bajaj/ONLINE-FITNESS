   ...
   public class BalPTSearch
    {
        ...
        public int Get_MaxMemberID()
        {
            ...
            res = obDataCon.Int_StoredProcedure_Parameter("SP_PT_Save ", param);
            return res;
        }
        ...
        public DataTable Get_SubMemberID1()
        {
            ...
            return obDataCon.DataTable_StoredProcedure_Parameter("SP_PT_Save ", param);
        }
        #endregion 
        ...
        public int Insert_Member_Sub()
        {
            ...
            return obDataCon.Insert_Update_Delete_StoredProcedure_Parameter("SP_PT_Save ", param);
        }
        #endregion
      ...
      //--------------------------------Attendance Seraching------------------------

        public DataTable BindGV_Atten()
        {

            SqlParameter[] param = new SqlParameter[5];
            param[0] = new SqlParameter("@Company_AutoID", Company_AutoID);
            param[1] = new SqlParameter("@Branch_AutoID", Branch_AutoID);
            param[2] = new SqlParameter("@Action", "BindGV_Atten");
            param[3] = new SqlParameter("@Category", Category);
            param[4] = new SqlParameter("@searchTxt", searchTxt);
            return obDataCon.DataTable_StoredProcedure_Parameter("SP_PT_Save ", param);
        ...
        public DataTable SearchByDate_Atten()
        {
        ...
        public DataTable SearchByDateWithCategory_Atten()
        {
            SqlParameter[] param = new SqlParameter[7];
            param[0] = new SqlParameter("@Company_AutoID", Company_AutoID);
            param[1] = new SqlParameter("@Branch_AutoID", Branch_AutoID);
            param[2] = new SqlParameter("@Action", "SearchByDateWithCategory_AttenDance");
            param[3] = new SqlParameter("@Category", Category);
            param[4] = new SqlParameter("@searchTxt", searchTxt);
            param[5] = new SqlParameter("@payDate", payDate);
            param[6] = new SqlParameter("@payDate1", payDate1);
