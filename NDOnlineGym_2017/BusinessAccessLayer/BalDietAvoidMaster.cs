...
{
    public class BalDietAvoidMaster
    {
        #region ------------Public Properties -----------

        public int DietAvoid_AutoID { get; set; }
        ...
        public DataTable Select_DietAvoidMaster()
        {
            ...
            return obDataCon.DataTable_StoredProcedure_Parameter("SP_DietAvoidMaster", param);
        }
        #endregion

        #region Insert record in Department Master Table
        public int Insert_DietAvoidMaster()
        {
            SqlParameter[] param = new SqlParameter[5];
            param[0] = new SqlParameter("@DietAvoid_AutoID", DietAvoid_AutoID);
            ...
            return obDataCon.Insert_Update_Delete_StoredProcedure_Parameter("SP_DietAvoidMaster", param);
        }
        #endregion
