...
{
    public class BalMuscularGroupMaster
    {
        ...
        public bool Check_ExistingNameMuscularGroupMaster()
        {
            ...
            int i = obDataCon.Int_StoredProcedure_Parameter("SP_MuscularGroupMaster", param);
            if (i > 0)
                return true;
            else
                return false;
        ...
        public DataTable Select_MuscularGroupMaster()
        {
            ...
            return obDataCon.DataTable_StoredProcedure_Parameter("SP_MuscularGroupMaster", param);
        }
        #endregion

        #region Insert record in Department Master Table
        public int Insert_MuscularGroupMaster()
        {
            SqlParameter[] param = new SqlParameter[5];
            param[0] = new SqlParameter("@MuscularGroup_AutoID", MuscularGroup_AutoID);
            ...
            return obDataCon.Insert_Update_Delete_StoredProcedure_Parameter("SP_MuscularGroupMaster", param);
        }
        #endregion

        #region Select record from Department Master by ID
        public DataTable SelectByID_MuscularGroupMaster()
        {
            SqlParameter[] param = new SqlParameter[4];
            param[0] = new SqlParameter("@MuscularGroup_AutoID", MuscularGroup_AutoID);
            param[1] = new SqlParameter("@Company_AutoID", Company_AutoID);
